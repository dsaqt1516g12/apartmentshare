...
var creationTimestamp = new Date( creationTimestampformat );
 ...
 // var a = '<a class="list-group-item" href="'+ uri +'/'+ id + '</a>';
  ...
  var ti= '<p class="list-group-item-text unclickable">' + 'Información del piso '+ '</p>';
  var p = '<m class="list-group-item-text unclickable">' + 'Descripción: '+ description  + '</m>' ;
  var m = '<h6 class="list-group-item-text unclickable">' +  'Dirección: '+ address+ '</h6>';

var campusid = '<h6 class="list-group-item-heading unclickable" align="center">'+ 'Campus más cercano: '+  campusid + '</h6>';;
