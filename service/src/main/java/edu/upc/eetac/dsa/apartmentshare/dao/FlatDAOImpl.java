    ...
    public FlatCollection getFlats(long timestamp, boolean before) throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                flat.setDescription(rs.getString("description"));
                flat.setNumpartner(rs.getInt("numpartner"));
                flat.setNumpartner(rs.getInt("smoker"));
                flat.setNumpartner(rs.getInt("pets"));
                flat.setNumpartner(rs.getInt("girlorboy"));
                flat.setNumpartner(rs.getInt("sqm"));
                flat.setNumpartner(rs.getInt("furnished"));
                flat.setNumpartner(rs.getInt("numrooms"));
                flat.setNumpartner(rs.getInt("numbathrooms"));
                flat.setNumpartner(rs.getInt("elevator"));
                flat.setNumpartner(rs.getInt("plantnum"));
                flat.setNumpartner(rs.getInt("internet"));
                flat.setNumpartner(rs.getInt("fianza"));
                flat.setNumpartner(rs.getInt("estancia"));
                flat.setCreationTimestamp(rs.getTimestamp("creation_timestamp").getTime());
                flat.setLastModified(rs.getTimestamp("last_modified").getTime());
                if (first) {
